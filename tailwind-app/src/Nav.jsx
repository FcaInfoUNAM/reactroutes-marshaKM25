...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  {/* map para crear dinámicamente la lista de navegación a partir del arreglo navigation*/}
  {navigation.map(e =>
    <li key={e.title}>
      <a href={e.href} className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
        {e.title}
      </a>
    </li>
  )}
